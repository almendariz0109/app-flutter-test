...
class SKUSReportPage extends StatefulWidget {
  final List<SupplyingWarehouse> reports;

  const SKUSReportPage({super.key, required this.reports});

  @override
  State<SKUSReportPage> createState() => _SKUSReportPageState();
}

class _SKUSReportPageState extends State<SKUSReportPage> {
  String _searchQuery = '';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Reporte de SKUs Según Cobertura'),
        centerTitle: true,
